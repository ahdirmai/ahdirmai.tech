        ...
        >
          ...
          <div className="flex flex-wrap gap-4 justify-center lg:justify-start mb-8">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="btn btn-outline w-12 h-12 flex items-center justify-center hover:shadow-retro-lg hover:-translate-y-1 hover:translate-x-1 transition-all duration-200"
              aria-label="LinkedIn"
            >
